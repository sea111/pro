...
$("#all").append("<div class='div1'><div class='top'><p class='p1'>姓名："+datas.name+"</p><p class='p2'>电话："+datas.phone+"</p><p class='p3'>地址："+datas.add+"</p></div><div class='bottom'><input type='radio' name='xuan' class='inp1'/><span>配送至此</span><img src='../img/gai.gif' class='img1'/><img src='../img/shan.gif' dataid=" + num +" class='img2' /></div></div>")	
	}
})
